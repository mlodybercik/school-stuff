import time
import itertools
from typing import Deque, Dict, Any, Tuple, Type
...
class Aggregator:
    ...
    def __init__(self, topic: str, logic: Type["AggregatorLogic"], timeperiod: int) -> None:
    ...
    def getData(self) -> Dict[str, Any]:
        ...
        for i, to in enumerate(self.data[0]):
            if from_ > to:
                break
        return self.logic.execute(list(itertools.islice(self.data[1], 0, i))) # type: ignore
